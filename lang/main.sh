...
MSG_F2B_CONFIG_NOT_FOUND="Fail2ban configuration file not found: $FAIL2BAN_CONF_FILE"
MSG_F2B_CONFIG_NOT_FOUND_RU="Файл конфигурации Fail2ban не найден: $FAIL2BAN_CONF_FILE"

MSG_F2B_CONFIG_FOUND="Fail2ban configuration found at $FAIL2BAN_CONF_FILE"
MSG_F2B_CONFIG_FOUND_RU="Конфигурация Fail2ban найдена в $FAIL2BAN_CONF_FILE"
...
MSG_SINGBOX_DOWNLOAD_FAILED="Failed to download Sing-box from: $sb_url"
MSG_SINGBOX_DOWNLOAD_FAILED_RU="Не удалось загрузить Sing-box из: $sb_url"
...
MSG_SINGBOX_INSTALLED="Installed: $SINGBOX_BINARY"
MSG_SINGBOX_INSTALLED_RU="Установлено: $SINGBOX_BINARY"

MSG_SINGBOX_INSTALLING="Installing Sing-box"
MSG_SINGBOX_INSTALLING_RU="Устанавливаю Sing-box"

MSG_SINGBOX_ALREADY_INSTALLED="Sing-box already installed: $cur_ver"
MSG_SINGBOX_ALREADY_INSTALLED_RU="Sing-box уже установлен: $cur_ver"
...
MSG_SINGBOX_UP_TO_DATE="Sing-box already up to date: $sb_tag"
MSG_SINGBOX_UP_TO_DATE_RU="Sing-box уже обновлён: $sb_tag"

MSG_SINGBOX_UPDATED="Sing-box updated to $sb_tag"
MSG_SINGBOX_UPDATED_RU="Sing-box обновлён до $sb_tag"
...
MSG_MARZBAN_INSTALL_LOG="Marzban install log: $_marzban_log"
MSG_MARZBAN_INSTALL_LOG_RU="Лог установки Marzban: $_marzban_log"
...
MSG_MARZBAN_FULL_LOG="Full install log: $_marzban_log"
MSG_MARZBAN_FULL_LOG_RU="Полный лог установки: $_marzban_log"
...
MSG_MARZBAN_PORTS_LOADED="Loaded ports from $ports_file"
MSG_MARZBAN_PORTS_LOADED_RU="Порты загружены из $ports_file"

MSG_MARZBAN_ENV_NOT_FOUND=".env file not found, creating..."
MSG_MARZBAN_ENV_NOT_FOUND_RU=".env файл не найден, создаю..."

MSG_MARZBAN_ENV_CREATED="Marzban .env created with domain=$domain, panel=$PANEL_PORT, sub=$SUB_PORT"
MSG_MARZBAN_ENV_CREATED_RU="Marzban .env создан: домен=$domain, панель=$PANEL_PORT, подписка=$SUB_PORT"

MSG_MARZBAN_ENV_UPDATED="Marzban .env updated with domain=$domain, panel=$PANEL_PORT, sub=$SUB_PORT"
MSG_MARZBAN_ENV_UPDATED_RU="Marzban .env обновлён: домен=$domain, панель=$PANEL_PORT, подписка=$SUB_PORT"
