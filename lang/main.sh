...
MSG_MARZBAN_INSTALL_LOG="Marzban install log: \${arg_1}"
MSG_MARZBAN_INSTALL_LOG_RU="Лог установки Marzban: \${arg_1}"
...
MSG_MARZBAN_FULL_LOG="Full install log: \${arg_1}"
MSG_MARZBAN_FULL_LOG_RU="Полный лог установки: \${arg_1}"
...
MSG_MARZBAN_PORTS_LOADED="Loaded ports from \${arg_1}"
MSG_MARZBAN_PORTS_LOADED_RU="Порты загружены из \${arg_1}"

MSG_MARZBAN_ENV_NOT_FOUND=".env file not found, creating..."
MSG_MARZBAN_ENV_NOT_FOUND_RU=".env файл не найден, создаю..."

MSG_MARZBAN_ENV_CREATED="Marzban .env created with domain=\${arg_1}, panel=\${arg_1}, sub=\${arg_1}"
MSG_MARZBAN_ENV_CREATED_RU="Marzban .env создан: домен=\${arg_1}, панель=\${arg_1}, подписка=\${arg_1}"

MSG_MARZBAN_ENV_UPDATED="Marzban .env updated with domain=\${arg_1}, panel=\${arg_1}, sub=\${arg_1}"
MSG_MARZBAN_ENV_UPDATED_RU="Marzban .env обновлён: домен=\${arg_1}, панель=\${arg_1}, подписка=\${arg_1}"
...
MSG_BACKUP_MARZBAN_DIR_NOT_FOUND="Marzban directory not found: \${arg_1}"
MSG_BACKUP_MARZBAN_DIR_NOT_FOUND_RU="Директория Marzban не найдена: \${arg_1}"
...
MSG_MONITOR_MARZBAN_ERRORS="Found \${arg_1} errors in Marzban logs (last hour)"
MSG_MONITOR_MARZBAN_ERRORS_RU="Найдено ошибок в логах Marzban (за последний час): \${arg_1}"
