...
MSG_SINGBOX_UP_TO_DATE="Sing-box already up to date: \$$1"
MSG_SINGBOX_UP_TO_DATE_RU="Sing-box уже обновлён: \$$1"

MSG_SINGBOX_UPDATED="Sing-box updated to \$$1"
MSG_SINGBOX_UPDATED_RU="Sing-box обновлён до \$$1"
...
# MODULE: MARZBAN
# ══════════════════════════════════════════════════════════════
MSG_MARZBAN_INSTALLING="Installing Marzban"
MSG_MARZBAN_INSTALLING_RU="Устанавливаю Marzban"

MSG_MARZBAN_ALREADY_INSTALLED="Marzban already installed"
MSG_MARZBAN_ALREADY_INSTALLED_RU="Marzban уже установлен"

MSG_MARZBAN_DOWNLOAD_SCRIPT="Downloading Marzban installation script..."
MSG_MARZBAN_DOWNLOAD_SCRIPT_RU="Загружаю скрипт установки Marzban..."

MSG_MARZBAN_DOWNLOAD_FAILED="Failed to download Marzban installation script"
MSG_MARZBAN_DOWNLOAD_FAILED_RU="Не удалось загрузить скрипт установки Marzban"

MSG_MARZBAN_CONTINUE_MANUAL="Continuing without Marzban — you can install manually later:"
MSG_MARZBAN_CONTINUE_MANUAL_RU="Продолжаю без Marzban — сможете установить вручную позже:"

MSG_MARZBAN_RUNNING_INSTALL="Running Marzban installation..."
MSG_MARZBAN_RUNNING_INSTALL_RU="Запускаю установку Marzban..."

MSG_MARZBAN_INSTALL_DEPS="Installing Marzban dependencies..."
MSG_MARZBAN_INSTALL_DEPS_RU="Устанавливаю зависимости Marzban..."

MSG_MARZBAN_DEPS_FAILED="Failed to install some dependencies, continuing anyway..."
MSG_MARZBAN_DEPS_FAILED_RU="Не удалось установить некоторые зависимости, продолжаю..."

MSG_MARZBAN_CHECK_DOCKER="Checking Docker service..."
MSG_MARZBAN_CHECK_DOCKER_RU="Проверяю сервис Docker..."

MSG_MARZBAN_DOCKER_RUNNING="Docker is already running"
MSG_MARZBAN_DOCKER_RUNNING_RU="Docker уже запущен"

MSG_MARZBAN_START_DOCKER="Starting Docker service..."
MSG_MARZBAN_START_DOCKER_RU="Запускаю сервис Docker..."

MSG_MARZBAN_DOCKER_START_FAILED="Failed to start Docker service"
MSG_MARZBAN_DOCKER_START_FAILED_RU="Не удалось запустить сервис Docker"

MSG_MARZBAN_DOCKER_REQUIRED="Marzban requires Docker. Please start Docker manually:"
MSG_MARZBAN_DOCKER_REQUIRED_RU="Marzban требует Docker. Запустите Docker вручную:"

MSG_MARZBAN_DOCKER_NOT_WORKING="Docker is not working properly"
MSG_MARZBAN_DOCKER_NOT_WORKING_RU="Docker работает некорректно"

MSG_MARZBAN_CHECK_DOCKER_INSTALL="Please check Docker installation and try again"
MSG_MARZBAN_CHECK_DOCKER_INSTALL_RU="Проверьте установку Docker и попробуйте снова"

MSG_MARZBAN_ADD_DOCKER_GROUP="Adding user to docker group..."
MSG_MARZBAN_ADD_DOCKER_GROUP_RU="Добавляю пользователя в группу docker..."

MSG_MARZBAN_ADD_GROUP_FAILED="Failed to add user to docker group"
MSG_MARZBAN_ADD_GROUP_FAILED_RU="Не удалось добавить пользователя в группу docker"

MSG_MARZBAN_USE_SUDO="You may need to run Docker commands with sudo"
MSG_MARZBAN_USE_SUDO_RU="Возможно, потребуется запускать команды Docker с sudo"

MSG_MARZBAN_REMOVE_CONTAINER="Removing existing Marzban container..."
MSG_MARZBAN_REMOVE_CONTAINER_RU="Удаляю существующий контейнер Marzban..."

MSG_MARZBAN_REMOVE_VOLUME="Removing existing Marzban volume..."
MSG_MARZBAN_REMOVE_VOLUME_RU="Удаляю существующий volume Marzban..."

MSG_MARZBAN_REMOVE_DIR="Removing existing Marzban directory /opt/marzban..."
MSG_MARZBAN_REMOVE_DIR_RU="Удаляю существующую директорию Marzban /opt/marzban..."
...
MSG_MARZBAN_FULL_LOG="Full install log: \$$1"
MSG_MARZBAN_FULL_LOG_RU="Полный лог установки: \$$1"

MSG_MARZBAN_INSTALLED_SUCCESS="Marzban installed successfully"
MSG_MARZBAN_INSTALLED_SUCCESS_RU="Marzban успешно установлен"

MSG_MARZBAN_CONFIG_ENV="Configuring Marzban .env"
MSG_MARZBAN_CONFIG_ENV_RU="Настраиваю .env Marzban"

MSG_MARZBAN_PORTS_LOADED="Loaded ports from \$$1"
MSG_MARZBAN_PORTS_LOADED_RU="Порты загружены из \$$1"

MSG_MARZBAN_ENV_NOT_FOUND=".env file not found, creating..."
MSG_MARZBAN_ENV_NOT_FOUND_RU=".env файл не найден, создаю..."

MSG_MARZBAN_ENV_CREATED="Marzban .env created with domain=\$$1, panel=\$$1, sub=\$$1"
MSG_MARZBAN_ENV_CREATED_RU="Marzban .env создан: домен=\$$1, панель=\$$1, подписка=\$$1"

MSG_MARZBAN_ENV_UPDATED="Marzban .env updated with domain=\$$1, panel=\$$1, sub=\$$1"
MSG_MARZBAN_ENV_UPDATED_RU="Marzban .env обновлён: домен=\$$1, панель=\$$1, подписка=\$$1"

MSG_MARZBAN_CREDS_SAVED="Admin credentials saved to /etc/cubiveil/admin.credentials"
MSG_MARZBAN_CREDS_SAVED_RU="Учётные данные админа сохранены в /etc/cubiveil/admin.credentials"

MSG_MARZBAN_CONFIG_SSL="Configuring SSL for Marzban"
MSG_MARZBAN_CONFIG_SSL_RU="Настраиваю SSL для Marzban"

MSG_MARZBAN_SSL_CONFIGURED="SSL certificates configured for Marzban"
MSG_MARZBAN_SSL_CONFIGURED_RU="SSL сертификаты настроены для Marzban"

MSG_MARZBAN_SSL_BY_MODULE="SSL certificates will be configured by ssl module"
MSG_MARZBAN_SSL_BY_MODULE_RU="SSL сертификаты будут настроены модулем ssl"

MSG_MARZBAN_ENABLING="Enabling Marzban service"
MSG_MARZBAN_ENABLING_RU="Включаю сервис Marzban"

MSG_MARZBAN_CONTAINER_NOT_FOUND="Marzban container not found"
MSG_MARZBAN_CONTAINER_NOT_FOUND_RU="Контейнер Marzban не найден"

MSG_MARZBAN_CONTAINER_RUNNING="Marzban Docker container is running"
MSG_MARZBAN_CONTAINER_RUNNING_RU="Docker контейнер Marzban запущен"

MSG_MARZBAN_STARTING_CONTAINER="Starting Marzban Docker container..."
MSG_MARZBAN_STARTING_CONTAINER_RU="Запускаю Docker контейнер Marzban..."

MSG_MARZBAN_START_CONTAINER_FAILED="Failed to start Marzban container"
MSG_MARZBAN_START_CONTAINER_FAILED_RU="Не удалось запустить контейнер Marzban"

MSG_MARZBAN_WAIT_START="Waiting for Marzban to start..."
MSG_MARZBAN_WAIT_START_RU="Ожидание запуска Marzban..."

MSG_MARZBAN_IS_RUNNING="Marzban is running"
MSG_MARZBAN_IS_RUNNING_RU="Marzban запущен"

MSG_MARZBAN_NOT_RUNNING="Marzban is not running"
MSG_MARZBAN_NOT_RUNNING_RU="Marzban не запущен"

MSG_MARZBAN_ENABLED_STARTED="Marzban enabled and started"
MSG_MARZBAN_ENABLED_STARTED_RU="Marzban включён и запущен"

MSG_MARZBAN_DISABLING="Disabling Marzban service"
MSG_MARZBAN_DISABLING_RU="Отключаю сервис Marzban"

MSG_MARZBAN_SERVICE_DISABLED="Marzban service disabled"
MSG_MARZBAN_SERVICE_DISABLED_RU="Сервис Marzban отключён"

MSG_MARZBAN_HEALTH_CHECK="Checking Marzban health"
MSG_MARZBAN_HEALTH_CHECK_RU="Проверка здоровья Marzban"

MSG_MARZBAN_SERVICE_NOT_ACTIVE="Marzban service is not active"
MSG_MARZBAN_SERVICE_NOT_ACTIVE_RU="Сервис Marzban не активен"

MSG_MARZBAN_ENV_FILE_NOT_FOUND="Marzban .env file not found"
MSG_MARZBAN_ENV_FILE_NOT_FOUND_RU="Файл .env Marzban не найден"

MSG_MARZBAN_CONFIG_DIR_NOT_FOUND="Marzban config directory not found"
MSG_MARZBAN_CONFIG_DIR_NOT_FOUND_RU="Директория конфигурации Marzban не найдена"

MSG_MARZBAN_HEALTH_PASSED="Marzban health check passed"
MSG_MARZBAN_HEALTH_PASSED_RU="Проверка здоровья Marzban пройдена"

MSG_MARZBAN_RESTARTING="Restarting Marzban"
MSG_MARZBAN_RESTARTING_RU="Перезапускаю Marzban"

MSG_MARZBAN_RESTARTED="Marzban restarted"
MSG_MARZBAN_RESTARTED_RU="Marzban перезапущен"

MSG_MARZBAN_STOPPING="Stopping Marzban"
MSG_MARZBAN_STOPPING_RU="Останавливаю Marzban"

MSG_MARZBAN_STOPPED="Marzban stopped"
MSG_MARZBAN_STOPPED_RU="Marzban остановлен"

MSG_MARZBAN_STARTING="Starting Marzban"
MSG_MARZBAN_STARTING_RU="Запускаю Marzban"

MSG_MARZBAN_STARTED="Marzban started"
MSG_MARZBAN_STARTED_RU="Marzban запущен"

MSG_MARZBAN_STATUS="Marzban status"
MSG_MARZBAN_STATUS_RU="Статус Marzban"

MSG_MARZBAN_REMOVING="Removing Marzban"
MSG_MARZBAN_REMOVING_RU="Удаляю Marzban"

MSG_MARZBAN_INSTALL_DIR_REMOVED="Marzban installation directory removed"
MSG_MARZBAN_INSTALL_DIR_REMOVED_RU="Директория установки Marzban удалена"

MSG_MARZBAN_SYSTEMD_REMOVED="Marzban systemd service removed"
MSG_MARZBAN_SYSTEMD_REMOVED_RU="Сервис systemd Marzban удалён"

MSG_MARZBAN_REMOVED="Marzban removed (data directory preserved)"
MSG_MARZBAN_REMOVED_RU="Marzban удалён (директория данных сохранена)"
...
MSG_BACKUP_MARZBAN_DIR_NOT_FOUND="Marzban directory not found: \$$1"
MSG_BACKUP_MARZBAN_DIR_NOT_FOUND_RU="Директория Marzban не найдена: \$$1"

MSG_BACKUP_SINGBOX_NOT_FOUND="Sing-box binary not found"
MSG_BACKUP_SINGBOX_NOT_FOUND_RU="Бинарник Sing-box не найден"

MSG_BACKUP_SSL_DIR_NOT_FOUND="SSL certificates directory not found: \$$1"
MSG_BACKUP_SSL_DIR_NOT_FOUND_RU="Директория SSL сертификатов не найдена: \$$1"
...
MSG_BACKUP_ENV_ISSUES="Found \$$1 environment issues, backup may be incomplete"
MSG_BACKUP_ENV_ISSUES_RU="Найдено проблем окружения: \$$1, бэкап может быть неполным"
...
MSG_BACKUP_SSL_CHECKING="Checking SSL certificate for: \$$1"
MSG_BACKUP_SSL_CHECKING_RU="Проверяю SSL сертификат для: \$$1"

MSG_BACKUP_SSL_VALID="SSL certificate is valid: \$$1"
MSG_BACKUP_SSL_VALID_RU="SSL сертификат действителен: \$$1"

MSG_BACKUP_SSL_INVALID="SSL certificate validation failed: \$$1"
MSG_BACKUP_SSL_INVALID_RU="Проверка SSL сертификата не удалась: \$$1"
...
MSG_BACKUP_ARCHIVE_CREATED="Backup archive created: \$$1 (\$$1)"
MSG_BACKUP_ARCHIVE_CREATED_RU="Архив бэкапа создан: \$$1 (\$$1)"
...
MSG_MONITOR_NETWORK_REACHABLE="Network: reachable to \$$1"
MSG_MONITOR_NETWORK_REACHABLE_RU="Сеть: доступно соединение с \$$1"
...
MSG_MONITOR_SSL_CHECKING="Checking SSL certificate for: \$$1"
MSG_MONITOR_SSL_CHECKING_RU="Проверка SSL сертификата для: \$$1"

MSG_MONITOR_SSL_VALID="SSL certificate valid: \$$1"
MSG_MONITOR_SSL_VALID_RU="SSL сертификат действителен: \$$1"

MSG_MONITOR_SSL_FAILED="SSL certificate check failed: \$$1"
MSG_MONITOR_SSL_FAILED_RU="Проверка SSL сертификата не удалась: \$$1"

MSG_MONITOR_SSL_ALERT="\$$1 SSL certificate checks failed"
MSG_MONITOR_SSL_ALERT_RU="Проверок SSL сертификатов не удалось: \$$1"
...
MSG_MONITOR_MARZBAN_ERRORS="Found \$$1 errors in Marzban logs (last hour)"
MSG_MONITOR_MARZBAN_ERRORS_RU="Найдено ошибок в логах Marzban (за последний час): \$$1"
...
MSG_MONITOR_SINGBOX_ERRORS="Found \$$1 errors in Sing-box logs"
MSG_MONITOR_SINGBOX_ERRORS_RU="Найдено ошибок в логах Sing-box: \$$1"
...
MSG_MONITOR_FAIL2BAN_BANS="Fail2ban: currently banned \$$1 IPs"
MSG_MONITOR_FAIL2BAN_BANS_RU="Fail2ban: сейчас забанено IP: \$$1"
...
MSG_MONITOR_REPORT_GENERATED="Report generated: \$$1"
MSG_MONITOR_REPORT_GENERATED_RU="Отчёт сгенерирован: \$$1"
...
MSG_DECOY_CONFIG_NOT_FOUND="Decoy nginx config not found: \$$1"
MSG_DECOY_CONFIG_NOT_FOUND_RU="Конфиг nginx для decoy не найден: \$$1"
...
MSG_DECOY_NGINX_CONFIG_ERROR="Nginx configuration error: \$$1"
MSG_DECOY_NGINX_CONFIG_ERROR_RU="Ошибка конфигурации nginx: \$$1"
...
MSG_RB_KEY_NOT_FOUND="Encryption key not found: \$$1"
MSG_RB_KEY_NOT_FOUND_RU="Ключ шифрования не найден: \$$1"
...
MSG_RB_INTEGRITY_FAILED="Integrity checks failed: \$$1 files corrupted"
MSG_RB_INTEGRITY_FAILED_RU="Проверки целостности не пройдены: файлов повреждено \$$1"
...
MSG_RB_USING_LATEST="Using latest backup: $(basename "\$$1")"
MSG_RB_USING_LATEST_RU="Использую последний бэкап: $(basename "\$$1")"
...
MSG_RB_LATEST_BACKUP="Latest backup: $(basename "\$$1")"
MSG_RB_LATEST_BACKUP_RU="Последний бэкап: $(basename "\$$1")"
