...
**CubiVeil** — это комплексное решение для развёртывания и управления инфраструктурой на базе **s-ui** (алреза0/x-ui) с поддержкой Xray и Sing-box на серверах Ubuntu.
