...
<p align="center">
  <strong>Автоматизированная установка и управление s-ui (Xray/Sing-box)</strong>
</p>
...
**CubiVeil** — это комплексное решение для развёртывания и управления инфраструктурой на базе **S-UI** (alireza0/s-ui) с встроенным Sing-box на серверах Ubuntu.
...
4. Установит s-ui панель (с встроенным Xray/Sing-box)
5. Настроит SSL-сертификаты Let's Encrypt (через встроенный ACME s-ui)
...
| Компонент | Описание |
|-----------|----------|
| **S-UI Panel** | Панель управления с встроенным Sing-box |
| **Sing-box** | Ядро с поддержкой современных протоколов (встроено в S-UI) |
