...
# ╓        РўРµСЃС‚РёСЂРѕРІР°РЅРёРµ РіР»Р°РІРЅРѕР№ С‚РѕС‡РєРё РІС...РѕРґР°                  ╓
# ╚═══════════════════════════════════════════════════════════╝
...
# ── Mock С„СѓРЅРєС†РёР№ РІС‹РІРѕРґР° ──────────────────────────────────────
...
# ── РўРµСЃС‚: С„Р°Р№Р» СЃСѓС‰РµСЃС‚РІСѓРµС‚ ───────────────────────────────────────
test_file_exists() {
...
# ── РўРµСЃС‚: СЃРёРЅС‚Р°РєСЃРёСЃ СЃРєСЂРёРїС‚Р° ───────────────────────────────────
test_syntax() {
...
# ── РўРµСЃС‚: СЃРєСЂРёРїС‚ РёРјРµРµС‚ shebang ────────────────────────────────
test_shebang() {
...
# ── РўРµСЃС‚: strict mode РІРєР»СЋС‡С'РЅ ─────────────────────────────────
test_strict_mode() {
...
# ── РўРµСЃС‚: Р·Р°РіСЂСѓР·РєР° РјРѕРґСѓР»РµР№ ────────────────────────────────────
test_module_loading() {
...
# ── РўРµСЃС‚: С„СѓРЅРєС†РёСЏ main СЃСѓС‰РµСЃС‚РІСѓРµС‚ ─────────────────────────────
test_main_function() {
...
# ── РўРµСЃС‚: С„СѓРЅРєС†РёСЏ main РІС‹Р·С‹РІР°РµС‚СЃСЏ ─────────────────────────────
test_main_call() {
...
# ── РўРµСЃС‚: РёСЃРїРѕР»СЊР·РѕРІР°РЅРёРµ С„СѓРЅРєС†РёР№ РёР· РјРѕРґСѓР»РµР№ ────────────────────
...
# ── РўРµСЃС‚: РїРѕСЃР»РµРґРѕРІР°С‚РµР»СЊРЅРѕСЃС‚СЊ С€Р°РіРѕРІ СѓСЃС‚Р°РЅРѕРІРєРё ──────────────────
...
# ── РўРµСЃС‚: step_traffic_shaping РїРѕСЃР»Рµ step_decoy_site ──────────
...
# ── РўРµСЃС‚: РѕР±СЂР°Р±РѕС‚РєР° РѕС€РёР±РѕРє ────────────────────────────────────
test_error_handling() {
...
# ── РўРµСЃС‚: fallback РґР»СЏ lang/main.sh ────────────────────────────────
test_lang_fallback() {
...
# ── РўРµСЃС‚: СЂР°Р·РјРµСЂС‹ СЃРєСЂРёРїС‚Р° ─────────────────────────────────────
test_script_size() {
...
# ── РўРµСЃС‚: РЅР°Р»РёС‡РёРµ РєРѕРјРјРµРЅС‚Р°СЂРёРµРІ ────────────────────────────────
test_comments() {
...
# ── РўРµСЃС‚: Р·Р°РїСѓСЃРє Р±РµР· root (РґРѕР»Р¶РµРЅ РїРѕРєР°Р·Р°С‚СЊ РїСЂРµРґСѓРїСЂРµР¶РґРµРЅРёРµ) ───
...
# ── РўРµСЃС‚: РїСЂРѕРІРµСЂРєР° РЅР° Ubuntu ──────────────────────────────────
test_ubuntu_check() {
...
# ── РўРµСЃС‚: РїРµСЂРµРјРµРЅРЅС‹Рµ РѕРєСЂСѓР¶РµРЅРёСЏ ────────────────────────────────
...
# ── РўРµСЃС‚: РёРЅС‚РµРіСЂР°С†РёСЏ СЃ setup-telegram.sh ──────────────────────
...
# ── РўРµСЃС‚: dry-run СЃРёРјСѓР»СЏС†РёСЏ (mock) ────────────────────────────
test_dry_run_simulation() {
  # Mock С„СѓРЅРєС†РёР№ (РґРѕР»Р¶РЅС‹ Р±С‹С‚СЊ РѕРїСЂРµРґРµР»РµРЅС‹ РґРѕ РёСЃРїРѕР»СЊР·РѕРІР°РЅРёСЏ)
  select_language() { :; }
  print_banner() { :; }
  prompt_inputs() {
...
# ── РўРµСЃС‚: Р±РµР·РѕРїР°СЃРЅРѕСЃС‚СЊ (РѕС‚СЃСѓС‚СЃС‚РІРёРµ С...Р°СЂРґРєРѕРґРЅС‹С... СЃРµРєСЂРµС‚РѕРІ) ───────
...
# ── РўРµСЃС‚: РёСЃРїРѕР»СЊР·РѕРІР°РЅРёРµ РєР°РІС‹С‡РµРє ───────────────────────────────
test_quoting_usage() {
