...
# ╓        РўРµСЃС‚РёСЂРѕРІР°РЅРёРµ lib/modules/traffic-shaping/         ╓
# ╚═══════════════════════════════════════════════════════════╝
...
# ── Р-Р°РіСЂСѓР·РєР° С‚РµСЃС‚РёСЂСѓРµРјС‹С... РјРѕРґСѓР»РµР№ ───────────────────────────────
...
# ── РўРµСЃС‚: С„Р°Р№Р»С‹ СЃСѓС‰РµСЃС‚РІСѓСЋС‚ ───────────────────────────────────────
test_files_exist() {
...
# ── РўРµСЃС‚: СЃРёРЅС‚Р°РєСЃРёСЃ СЃРєСЂРёРїС‚РѕРІ ───────────────────────────────────
test_syntax() {
...
# ── РўРµСЃС‚: ts_write_systemd_service ──────────────────────────────
...
# ── РўРµСЃС‚: СѓРЅРёРєР°Р»СЊРЅРѕСЃС‚СЊ РїР°СЂР°РјРµС‚СЂРѕРІ ───────────────────────────────
...
# ── РўРµСЃС‚: РЅР°Р»РёС‡РёРµ РІСЃРµС... РѕСЃРЅРѕРІРЅС‹С... С„СѓРЅРєС†РёР№ ────────────────────────
...
# ── РўРµСЃС‚: ts_check_compatibility ──────────────────────────────
...
# ── РўРµСЃС‚: ts_check_compatibility РѕР±РЅР°СЂСѓР¶РёРІР°РµС‚ СЃСѓС‰РµСЃС‚РІСѓСЋС‰РёРµ qdisc ──
...
# ── РўРµСЃС‚: ts_check_compatibility РїСЂРѕРІРµСЂСЏРµС‚ Docker/LXC ─────────
...
# ── РўРµСЃС‚: ts_check_compatibility РІ РЅРµРёРЅС‚РµСЂР°РєС‚РёРІРЅРѕРј СЂРµР¶РёРјРµ ─────
